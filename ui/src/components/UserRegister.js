  ...
  return (
    <section className="bg-white">
      <div className="lg:grid lg:min-h-screen lg:grid-cols-12 ">
        <div className="inset-y-0 left-0 lg:fixed lg:col-span-5 xl:col-span-6">
          <section className=" relative  flex h-32 items-end bg-gray-900  lg:h-full  ">
            ...
            <div className=" relative bottom-0 lg:block lg:p-12">
              <h2 className=" mt-6 text-9xl font-bold text-white sm:text-3xl md:text-4xl">
                Bem-vindo ao WTF ✈️
              </h2>

              <p className="  mt-4 leading-relaxed text-white/90 lg:text-xl">
        ...
        <main
          aria-label="Main"
          className="flex items-center justify-center px-8 py-8 sm:px-12 md:mt-48 lg:col-span-8 lg:col-start-5 lg:py-12 lg:px-16 xl:col-span-7 xl:col-start-6"
        >
          <div className="max-w-xl lg:max-w-3xl">
            ...
            <form action="#" class="mt-8 grid grid-cols-6 gap-6">
              ...
              <div class="col-span-6 mt-9 -mb-5 text-2xl">Dados Utilizador</div>
              <hr class="col-span-6 mb-3 h-px border-0 bg-black" />
              ...
              <div class="col-span-6 mt-9 -mb-5 text-2xl">Dados de Acesso</div>
              <hr class="col-span-6 mb-3 h-px border-0 bg-black" />
